...
def fit_models(X, y, index_train, index_pred, num2):
      ...
      nn_grid = {
        'epochs': [1,2,5,10,20],
        'lambda_value': 10**np.arange(-8, 0+0.1, 1.0)
      }
      ...
      f=open("weak/micro1_l1_result.txt","a")
...
for i in range(1, len(lines)):
    ...
    if(num1 == 7):
        ...
        num1+=1
'''
file_path = 'micro1_l1_result.txt'
...
plt.subplot(1, 2, 1)
plt.hist(df.iloc[:, -2], bins=100, color='blue', edgecolor='black')
